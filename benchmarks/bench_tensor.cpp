    ...
    void run(KinetBackend backend) {
        ...
        auto kernel = [&]() {
            ...
            if (op_name == "add") {
                ...
                c = kinet_tensor_mul(gpu, a, b);
            } else if (op_name == "div") {
                c = kinet_tensor_div(gpu, a, b);
            } else if (op_name == "sub") {
                c = kinet_tensor_sub(gpu, a, b);
            }
        };
    ...
    void run(KinetBackend backend) {
        ...
        auto kernel = [&]() {
            ...
            if (op_name == "sum") {
                ...
                out = kinet_tensor_max(gpu, data, axes, 1);
            } else if (op_name == "min") {
                out = kinet_tensor_min(gpu, data, axes, 1);
            } else if (op_name == "mean") {
                out = kinet_tensor_mean(gpu, data, axes, 1);
            }
        };
...
int main(int argc, char** argv) {
    printf("=== Kinet GPU Tensor Benchmarks ===\n\n");
