...
kernel void kinet_add_f32_vec4(
...
kernel void kinet_mul_f32_vec4(
    device const float4* a [[buffer(0)]],
    device const float4* b [[buffer(1)]],
    device float4* out [[buffer(2)]],
    constant uint& n4 [[buffer(3)]],
...
// C[M,N] = A[M,K] @ B[K,N]
kernel void kinet_matmul_tiled_f32(
    device const float* A [[buffer(0)]],
    device const float* B [[buffer(1)]],
...
kernel void kinet_transpose_f32(
...
kernel void kinet_reduce_sum_f32(
    device const float* input [[buffer(0)]],
...
kernel void kinet_reduce_max_f32(
    device const float* input [[buffer(0)]],
    device atomic_float* output [[buffer(1)]],
    constant uint& n [[buffer(2)]],
    uint idx [[thread_position_in_grid]],
...
kernel void kinet_reduce_min_f32(
    device const float* input [[buffer(0)]],
    device atomic_float* output [[buffer(1)]],
    constant uint& n [[buffer(2)]],
    uint idx [[thread_position_in_grid]],
...
kernel void kinet_reduce_sum_axis_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
...
kernel void kinet_reduce_max_axis_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
    constant uint& outer_size [[buffer(2)]],
    constant uint& inner_size [[buffer(3)]],
...
kernel void kinet_reduce_mean_axis_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
    constant uint& outer_size [[buffer(2)]],
    constant uint& inner_size [[buffer(3)]],
...
kernel void kinet_log_softmax_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
    constant uint& batch_size [[buffer(2)]],
    constant uint& dim [[buffer(3)]],
...
kernel void kinet_layer_norm_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
...
kernel void kinet_rms_norm_f32(
    device const float* input [[buffer(0)]],
    device float* output [[buffer(1)]],
