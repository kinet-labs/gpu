...
// =============================================================================
    ...
    #include <immintrin.h>
    #define KINET_HAS_AVX2
#elif defined(__aarch64__) || defined(_M_ARM64)
    #include <arm_neon.h>
    #define KINET_HAS_NEON
#endif
...
void kinet_cpu_softmax_f32(float* out, const float* in, size_t batch_size, size_t dim) {
    for (size_t b = 0; b < batch_size; b++) {
        ...
        float max_val = kinet_cpu_reduce_max_f32(x, dim);
...
void kinet_cpu_layer_norm_f32(float* out, const float* in, const float* gamma, const float* beta,
    ...
    for (size_t b = 0; b < batch_size; b++) {
        ...
        // Compute mean
        float mean = kinet_cpu_reduce_mean_f32(x, dim);
